...
<?php
	...
	$query = "SELECT * FROM filmi WHERE statusi='show' AND trend='on' ORDER BY film_id DESC LIMIT $offset, $limit";
...
<?php
	$sql = "SELECT * FROM filmi WHERE statusi='show' AND trend='on' ORDER BY film_id DESC";
...
?>
         ...
         <span id="<?php echo $i ?>" class="<?php echo $active?>"><a id="<?php echo $i ?>" class='inactive' href='/top/<?php echo $i ?>'><?php echo $i ?></a></span>
         <?php
	}
    ?>
          ...
          <div class='resppages'>
            <a href="/top/<?php echo $i ?>"><span class="fa fa-caret-right"></span>
            </a></div>
